...
import com.att.validator.science_degree.impl.ScienceDegreeAddValidatorImpl;
...
class ScienceDegreeAddValidatorTest {
    ...
    void validatorShouldInvokeAllMethods() {
        ...
        ScienceDegreeAddValidator validator = Mockito.spy(new ScienceDegreeAddValidatorImpl());
