...
import com.att.validator.academic_rank.impl.AcademicRankUpdateValidatorImpl;
...
class AcademicRankUpdateValidatorTest {
    ...
    void validatorShouldInvokeAllMethods() {
        ...
        AcademicRankUpdateValidator updateValidator = Mockito.spy(new AcademicRankUpdateValidatorImpl());
