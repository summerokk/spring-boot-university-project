...
import com.att.university.validator.academic_rank.impl.AcademicRankAddValidatorImpl;
...
class AcademicRankAddValidatorTest {
    ...
    void validatorShouldInvokeAllMethods() {
        ...
        AcademicRankAddValidator validator = spy(new AcademicRankAddValidatorImpl());
