...
import com.att.university.validator.science_degree.impl.ScienceDegreeUpdateValidatorImpl;
...
class ScienceDegreeUpdateValidatorTest {
    ...
    void validatorShouldInvokeAllMethods() {
        ...
        ScienceDegreeUpdateValidator updateValidator = spy(new ScienceDegreeUpdateValidatorImpl());
